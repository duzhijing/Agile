...
namespace AgileNews.Controllers
{
    ...
    [RoutePrefix("CrawlerGrab")]
    public class CrawlerGrabServiceController : ApiController//AuthorizeAttribute
    {
        ...
        //        var clientinfo = RedisHelper.Get<CrawlerGrab>(encryptTicket);
        //        if (clientinfo != null)
        //        {
        ...
        public ICrawlerGrabService CrawlerGrabService { get; set; }

        [HttpPost]
        public int CrawlerGrabAdd(CrawlerGrab crawlerGrab)
        {
            var result = CrawlerGrabService.CrawlerGrabAdd(crawlerGrab);
            return result;
        }
        [HttpDelete]
        public int CrawlerGrabDelete(int CrawlerGrabID)
        {
            var result = CrawlerGrabService.CrawlerGrabDelete(CrawlerGrabID);
            return result;
        }
        [HttpPut]
        ...
        {
            var CrawlerGrabList = CrawlerGrabService.GetCrawlerGrabs();
            return CrawlerGrabList;
        }
